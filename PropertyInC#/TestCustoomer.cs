...
{
    public class TestCustoomer
    {
        static void Main(string[] args)
        {
            Customer obj = new Customer(101, false, "Subhman", 5000.00, Cities.Kathmandu,"Bagmati","Nepal");
            ...
            obj.City = Cities.Gulmi;
            
            Console.WriteLine("Modified City :" + obj.City);

            Console.WriteLine("Current State :" + obj.State);
           // obj.State = "Lumbini";//This is invalid because current class is not  a child class of customer
